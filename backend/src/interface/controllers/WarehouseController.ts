...
} from "../../application/use-cases/WarehouseUseCases.js";
...
export class WarehouseController {
  ...
  async get(req: Request, res: Response) {
    try {
      return res.json(await getWarehouse.execute(req.params.id as string));
    } catch (e: any) {
  ...
  async update(req: Request, res: Response) {
    return res.json(await updateWarehouse.execute(req.params.id as string, req.body));
  }

  async delete(req: Request, res: Response) {
    await deleteWarehouse.execute(req.params.id as string);
