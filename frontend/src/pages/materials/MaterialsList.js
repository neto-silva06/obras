...
export function MaterialsList() {
    ...
    return (_jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h1", { className: "text-2xl font-bold text-gray-800", children: "Cat\u00E1logo de Materiais" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { variant: "secondary", onClick: () => navigate('/dashboard'), children: [_jsx(LayoutDashboard, { size: 18, className: "mr-2" }), " Dashboard"] }), _jsxs(Button, { onClick: () => navigate('/materials/new'), children: [_jsx(Plus, { size: 18, className: "mr-2" }), " Novo Material"] })] })] }), _jsx(DataTable, { columns: columns, data: materials, isLoading: isLoading, emptyMessage: "Nenhum material cadastrado." })] }));
}
