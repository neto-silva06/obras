...
export function WarehouseStock() {
    ...
    return (_jsxs("div", { className: "p-8", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsxs("h1", { className: "text-2xl font-bold", children: ["Estoque: ", warehouse?.name] }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs(Button, { variant: "ghost", onClick: () => navigate('/dashboard'), title: "Dashboard", children: [_jsx(LayoutDashboard, { size: 20, className: "mr-2" }), " Dashboard"] }), _jsx(Link, { to: "/warehouses", className: "text-blue-500 hover:underline", children: "Voltar aos Dep\u00F3sitos" })] })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [_jsxs("div", { className: "lg:col-span-2", children: [_jsx("h2", { className: "text-xl font-semibold mb-4", children: "Materiais em Estoque" }), _jsx(DataTable, { data: stocks, columns: [
