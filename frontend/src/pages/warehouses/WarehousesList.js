...
export function WarehousesList() {
    ...
    return (_jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsxs("div", { className: "flex items-center gap-4", children: [workId && (_jsxs(Button, { variant: "ghost", onClick: () => navigate('/warehouses'), children: [_jsx(ArrowLeft, { size: 18, className: "mr-2" }), " Voltar"] })), _jsx("h1", { className: "text-2xl font-bold text-gray-800", children: workId ? 'Depósitos da Obra' : 'Gestão de Depósitos' })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { variant: "secondary", onClick: () => navigate('/dashboard'), children: [_jsx(LayoutDashboard, { size: 18, className: "mr-2" }), " Dashboard"] }), _jsxs(Button, { onClick: () => navigate(workId ? `/warehouses/new?workId=${workId}` : '/warehouses/new'), children: [_jsx(Plus, { size: 18, className: "mr-2" }), " Novo Dep\u00F3sito"] })] })] }), _jsx(DataTable, { columns: columns, data: warehouses, isLoading: isLoading, emptyMessage: "Nenhum dep\u00F3sito encontrado." })] }));
}
